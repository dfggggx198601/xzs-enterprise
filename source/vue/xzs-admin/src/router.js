...
const constantRoutes = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '员工编辑', noCache: true, activeMenu: '/user/student/list' },
        hidden: true
      },
      {
        path: 'admin/list',
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('@/views/exam/question/bank-list'),
        name: 'ExamQuestionBankPageList',
      ...
      {
        path: 'daily-practice/list',
        component: () => import('@/views/exam/daily-practice/list'),
        name: 'DailyPracticePageList',
        meta: { title: '每日一练', noCache: true }
      },
      {
        path: 'daily-practice/edit',
        component: () => import('@/views/exam/daily-practice/edit'),
        name: 'DailyPracticeEdit',
        meta: { title: '每日一练编辑', noCache: true, activeMenu: '/exam/daily-practice/list' },
        hidden: true
      }
    ]
  },
  ...
  },
  {
    ...
    children: [
       {
          path: 'businessLine/list',
          component: () => import('@/views/education/business-line/list'),
          name: 'EducationBusinessLinePage',
          meta: { title: '部门列表', noCache: true }
       },
        {
          path: 'businessLine/edit',
          component: () => import('@/views/education/business-line/edit'),
          name: 'EducationBusinessLineEditPage',
          meta: { title: '部门编辑', noCache: true },
          hidden: true
       },
      {
        path: 'subject/list',
        ...
        meta: { title: '业务范围列表', noCache: true }
      },
      {
        path: 'subject/edit',
        component: () => import('@/views/education/subject/edit'),
        name: 'EducationSubjectEditPage',
        meta: { title: '业务范围编辑', noCache: true, activeMenu: '/education/subject/list' },
        hidden: true
      }
    ]
  },
  {
    ...
    children: [
      ...
      {
        path: 'analysis',
        component: () => import('@/views/answer/analysis'),
        name: 'AnswerAnalysisPage',
        meta: { title: '成绩分析', noCache: true }
      }
    ]
  },
  {
