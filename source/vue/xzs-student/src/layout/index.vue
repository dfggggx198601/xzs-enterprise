  ...
  <el-container>
    <el-header height="61" class="student-header">
      ...
      <el-menu class="el-menu-title" mode="horizontal" :default-active="defaultUrl" :router="true">
        ...
        <el-menu-item index="/daily-practice/index">每日一练</el-menu-item>
    ...
    <el-footer height="340" class="student-footer">
      <div class="foot-container">
        <div class="footer-main">
          ...
          <a href="https://www.mindskip.net/xzs.html" target="_blank" class="footer-main-link">培训考试系统</a>
        </div>
        <div class="footer-main">
          <h4>微信小程序</h4>
        ...
        <div class="footer-main">
          <h4>文档中心</h4>
          <a href="https://gitee.com/mindskip" target="_blank" class="footer-main-link">培训考试仓库地址</a>
          <a href="https://www.mindskip.net:999" target="_blank" class="footer-main-link">培训考试开发文档</a>
          <a href="https://ke.qq.com/course/3614230" target="_blank" class="footer-main-link">培训考试视频教程</a>
        </div>
      </div>
    </el-footer>
...
export default {
  ...
  methods: {
    routeSelect (path) {
      let topPath = ['/', '/index', '/paper/index', '/daily-practice/index', '/record/index', '/question/index']
