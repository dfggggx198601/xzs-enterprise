  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        {
          path: 'index',
          component: () => import('@/views/daily-practice/index'),
          name: 'DailyPracticeIndex',
          meta: { title: '每日一练' }
        }
      ]
    },
    ...
    { path: '/daily-practice/do', name: 'DailyPracticeDo', component: () => import('@/views/daily-practice/do'), meta: { title: '每日一练' } },
