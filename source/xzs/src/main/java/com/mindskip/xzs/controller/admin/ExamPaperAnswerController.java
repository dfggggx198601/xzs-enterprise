...
public class ExamPaperAnswerController extends BaseApiController {
    ...
    @RequestMapping(value = "/weakness/{examPaperId}", method = RequestMethod.POST)
    public RestResponse<List<ExamKnowledgeWeaknessVM>> weakness(@PathVariable Integer examPaperId) {
        return RestResponse.ok(examPaperAnswerService.weaknessAnalysis(examPaperId));
    }

    @RequestMapping(value = "/report/{examPaperId}", method = RequestMethod.POST)
    public RestResponse<ExamReportVM> report(@PathVariable Integer examPaperId) {
        return RestResponse.ok(examPaperAnswerService.report(examPaperId));
    }
