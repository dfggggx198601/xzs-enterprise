...
public interface QuestionService extends BaseService<Question> {
    ...
    int importQuestionsFromFileLibrary(InputStream inputStream, String fileName, Integer subjectId, String tag,
            Integer userId, String regulationSource);

    QuestionEditRequestVM matchQuestionByText(String screenText);
}
