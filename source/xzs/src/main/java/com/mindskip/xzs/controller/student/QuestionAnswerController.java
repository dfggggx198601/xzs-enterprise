...
public class QuestionAnswerController extends BaseApiController {
    ...
    public RestResponse<PageInfo<QuestionPageStudentResponseVM>> pageList(
        ...
        PageInfo<QuestionPageStudentResponseVM> page = PageInfoHelper.copyMap(pageInfo, q -> {
            ...
            vm.setRegulationSource(questionObject.getRegulationSource());
    ...
    public RestResponse<QuestionAnswerVM> select(@PathVariable Integer id) {
        ...
        TextContent textContent = textContentService.selectById(examPaperQuestionCustomerAnswer.getQuestionTextContentId());
        if (textContent != null) {
            QuestionObject questionObject = JsonUtil.toJsonObject(textContent.getContent(), QuestionObject.class);
            questionVM.setRegulationSource(questionObject.getRegulationSource());
        }
